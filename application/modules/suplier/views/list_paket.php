    ...
    <div class="card-body">
            ...
            <thead>             
              <tr class="active text-info">    
                ...
                <th width=30% class="text-center">Nama Paket</th> 
                <th width=18% class="text-center">No Kontrak</th>
                <th width=10% class="text-center">Tgl Kontrak</th>
                <th width=15% class="text-center">Tgl Akhir Kontrak</th>                      
...
$(document).ready(function()
{
	$("#datapaket").DataTable({
		...
		ajax 		: 	{
							"url" 	: "<?php echo base_url() ?>suplier/suplier/lookup",
							"type"	: "GET"
						},
		dom 		: 'T<"top"fl>rt<"bottom"ip><"clear">',
	            ...
	            "render" : function(data, type, row){	
							...
							return '<a class="btn btn-success btn-xs" href="<?=base_url()?>suplier/suplier/download/'+row[0]+'"><span class="glyphicon glyphicon-edit" ></span> Dokumen</a>' + ' &nbsp ' +
                                
                                 '<a class="btn btn-warning btn-xs" href="<?=base_url()?>suplier/suplier/detail/'+row[0]+'"><span class="glyphicon glyphicon-edit" ></span> Detail</a>'   ;
