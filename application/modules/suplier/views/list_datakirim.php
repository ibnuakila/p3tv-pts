    ...
    <div class="card-body">
            ...
            <thead>             
              <tr class="active text-info">    
                ...
                <th width=30% class="text-center">No Resi</th> 
                <th width=18% class="text-center">Nama PT</th>
                <th width=10% class="text-center">Tgl Kirim</th>
...
$(document).ready(function()
{
	$("#datapaket").DataTable({
		...
		ajax 		: 	{
							"url" 	: "<?php echo base_url() ?>suplier/suplier/lookupkirim2",
							"type"	: "GET"
						},
