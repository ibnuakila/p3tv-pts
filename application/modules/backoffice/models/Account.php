...
class Account extends CI_Model implements BaseModel
{
	...
	public function getByRelated($related, $field, $value, $row = Null, $segment = Null)
	{
            ...
            $this->db->from('user_pengusul as account');
	...
	{
		$data = array('status'=>$this->accountStatus);
		$this->db->where('id',$this->idAccount);
		$this->db->update('user_pengusul',$data);
	}
