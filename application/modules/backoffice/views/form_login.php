            ...
            <div class="col-md-6">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <!-- login form -->  
                        <form class="form-horizontal" name="login" method="post" action="<?php echo base_url()?>backoffice/login">
                            <fieldset>
                                <legend></legend>
                                ...
                                <div class="form-group ">
                                    <label for="inputEmail" class="col-lg-3 control-label">User&nbspID</label>
