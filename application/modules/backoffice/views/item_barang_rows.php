...
<div class="row mt-2">
        <div class="card" style="width:auto;">
            <div class="card-body">
                <table class="mytable table-light">
        <?php
        $i = 1;
        ...
        foreach ($item_barang->result() as $item) {
            ...
            ?>
                    ...
                    <tr>
                        <td>
                            <img src="<?= base_url() ?>assets/images/no-image.jpg" class="card-img" alt="...">
                        </td>
                        <td>
                            
                                <h5 class="card-title"><?= $item->barang . ' (' . $item->no_barang . ')' ?></h5>
                                <h6>Rp. <?= number_format($item->harga, 2) ?></h6>
                                <p class="card-text text-justify"><?= ($item->spesifikasi) ?></p>
                                <button href="" class="btn btn-outline-primary detail-barang" data-toggle="modal" 
            ...
            <div class="modal-body">
                ...
                <div class="col-md-12">
                    <div class="card-body">
                        ...
                        <h5>Spesifikasi:</h5>
                        <p class="card-text text-justify" id="text-spesifikasi">This is a wider card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
