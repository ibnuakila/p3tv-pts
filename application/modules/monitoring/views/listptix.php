		...
		<div class="panel-body">
            ...
            <thead>             
              <tr class="active text-info">                  
                ...
                <th width=6% class="text-center">Kode PT</th>
	...
	$("#datauser").DataTable({
		...
		dom 		: 'T<"top"fl>rt<"bottom"ip><"clear">',
	            ...
	            "render" : function(data, type, row){	
							...
							if(row[5]=='Tolak') {  
								return  '<a class="btn btn-danger btn-xs" target="_blank" href="../../../site/aliaslogin?id='+row[5]+'&admin=idc"><span class="glyphicon glyphicon-log-in" aria-hidden="true"></span> Login</a> '+  
										'<a class="btn btn-warning btn-xs" href="edituser/'+row[0]+'"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span> Edit</a> '+                                                                        
