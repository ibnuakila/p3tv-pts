              ...
              <center id="step_message"></center>
               ...
               <form method="post" action="<?php echo site_url('monitoring/kontak/savejawab'); ?>" class="form-horizontal" role="form">
                    ...
                    <div class="form-group" >
                        ...
                        <div class="col-lg-6">
                        <input name="nama" id="nmpti" class="form-control" value="<?php echo $row->nama; ?>" type="text" readonly>
                      </div>
                    </div>
...
<div class="">
                    <div class="form-group" >
                        ...
                        <div class="col-lg-6">
                        <input name="subjek" id="subjek" class="form-control" type="text" value="Jawab : <?php echo $row->judul; ?>">
                      </div>
                    </div>
