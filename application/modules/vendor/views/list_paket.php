...
$(document).ready(function()
{
	$("#datapaket").DataTable({
		...
		ajax 		: 	{
							"url" 	: "<?php echo base_url() ?>vendor/vendor/lookup",
							"type"	: "GET"
						},
		dom 		: 'T<"top"fl>rt<"bottom"ip><"clear">',
	            ...
	            "render" : function(data, type, row){	
							...
							return '<a class="btn btn-success btn-xs" href="<?=base_url()?>vendor/vendor/download/'+row[0]+'"><span class="glyphicon glyphicon-edit" ></span> Dokumen</a>' + ' &nbsp ' +
                                
                                 '<a class="btn btn-warning btn-xs" href="<?=base_url()?>vendor/vendor/detail/'+row[0]+'"><span class="glyphicon glyphicon-edit" ></span> Detail</a>'   ;
