...
<?php echo form_open_multipart('vendor/vendor/simpankirim/'); ?>	
    ...
    <div class="panel-body">
        ...
        <table class="table table-striped table-condensed table-hover"  >
            ...
            <tr class="alt">
                ...
                <td width="10" >:</td>
                <td><input class="form-control" type="text" id="alamat" name="alamat"  placeholder="Alamat ..." width="20px"/></td>                                               
            </tr>
            <tr class="alt">
                <td >Kota </td>
                <td >:</td>
                <td><input class="form-control" type="text" id="kota" name="kota"  placeholder="Kota ..." width="20px"/></td>                                               
            </tr>
            <tr class="alt">
