...
$(document).ready(function()
{
	$("#datapaket").DataTable({
		...
		ajax 		: 	{     
							"url" 	: "<?php echo base_url().'vendor/vendor/lookupdetil/'.$id ?> " ,
							"type"	: "GET"
						},
		dom 		: 'T<"top"fl>rt<"bottom"ip><"clear">',
	            ...
	            "render" : function(data, type, row){	
							...
							return '<a class="btn btn-warning btn-xs" href="<?=base_url()?>vendor/vendor/kirim/'+row[5]+row[0]+'"><span class="glyphicon glyphicon-edit" ></span> Kirim Barang</a>'   ;
